...
# Calculate "inverse" CRC. I.e. for each single-bit error, compute the corresponding CRC
# Print out sorted by CRC value, showing the corresponding bit-error position
l = {}
for j in range(8):
    c = crc(0, (1 << j))
